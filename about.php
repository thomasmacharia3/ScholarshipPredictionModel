        ...
        <div class="max-w-6xl mx-auto">
            <div class="flex-col items-center ">
                <div class="flex flex-col items-center justify-center w-full h-full max-w-2xl pr-8 mx-auto text-center">
                    <p class="my-5 text-base font-medium tracking-tight text-indigo-500 uppercase">About Scholar AI
                    </p>
                    <h2
                        ...
                        <blockquote
                            ...
                            <div class="flex flex-col pr-8">
                                <div class="relative pl-12">
                                    ...
                                    <p class="mt-2 text-base text-gray-600">The allocation process was so efficient and I was satisfied with the decision.
                                    </p>
                                </div>

                                <h3 class="pl-12 mt-3 text-base font-medium leading-5 text-gray-800 truncate">Sandra
                                    Walton <span class="mt-1 text-sm leading-5 text-gray-500 truncate">- Beneficiary
                                    </span></h3>
                        ...
                        <blockquote
                            ...
                            <div class="flex flex-col pr-10">
                                <div class="relative pl-12">
                                    ...
                                    <p class="mt-2 text-base text-gray-600">I am happy to see AI being intergrated into the scholarship system. It will increase the chances for all eligible candidates.</p>
                                </div>
                                <h3 class="pl-12 mt-3 text-base font-medium leading-5 text-gray-800 truncate">Kenny
                                    Jones <span class="mt-1 text-sm leading-5 text-gray-500 truncate">- Student
                                        </span></h3>
                                <p class="mt-1 text-sm leading-5 text-gray-500 truncate"></p>
                            </div>
                            <img class="flex-shrink-0 object-cover w-24 h-24 mb-5 bg-gray-300 rounded-full md:mb-0"
                        ...
                        <blockquote
                            ...
                            <div class="flex flex-col pr-10">
                                <div class="relative pl-12">
                                    ...
                                    <p class="mt-2 text-base text-gray-600">Extremely helpful in every step of the process. I was able to get my scholarship application in on time and with all the required documents.</p>
                                    </p>
                                </div>

                                <h3 class="pl-12 mt-3 text-base font-medium leading-5 text-gray-800 truncate">Mike Smith
                                    <span class="mt-1 text-sm leading-5 text-gray-500 truncate">- Scholarship Beneficiary</span>
                                </h3>
                                <p class="mt-1 text-sm leading-5 text-gray-500 truncate"></p>
                            </div>
                            <img class="flex-shrink-0 object-cover w-24 h-24 mb-5 bg-gray-300 rounded-full md:mb-0"
                            ...
                            <div class="flex flex-col pr-10">
                                <div class="relative pl-12">
                                    ...
                                    <p class="mt-2 text-base text-gray-600">Finally a quick and easy system I can use
                                        in the scholarship application process.</p>
                                </div>

                                <h3 class="pl-12 mt-3 text-base font-medium leading-5 text-gray-800 truncate">Molly
                                    Sanchez <span class="mt-1 text-sm leading-5 text-gray-500 truncate">- Lecturer
                            </span></h3>
                                <p class="mt-1 text-sm leading-5 text-gray-500 truncate"></p>
                            </div>
                            <img class="flex-shrink-0 object-cover w-24 h-24 mb-5 bg-gray-300 rounded-full md:mb-0"
